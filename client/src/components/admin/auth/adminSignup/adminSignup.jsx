...
export const AdminSignup = () => {
    ...
    const sendData = () => {
        ...
        // isCityValid && !isPasswordMatch && !isHospitalIdInvalid && hospitalNameValid && isPhoneValid && IsPinCodeValid && isSpecialityValid && isInformationValid
        if (buttonText == 'Sign Up') {
            ...
            Axios.post('http://localhost:5000/dashboard/hospital/register', formData , { withCredentials: true },{
                ...
                if (res.data.code === 1) {
                    ...
                    navigate('/hospital/dashboard'); //front end will make get request to backend
                }
                else {
        ...
        <div className="AdminSignUpform">
            ...
            <div className="textAndButtons">
                ...
                <label htmlFor="icon-button-file">
                    <Input onChange={selectPhoto} accept="image/*" id="icon-button-file" type="file" />
